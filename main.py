...
# Storage file - use absolute path in Docker
...
async def code_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await check_membership(update, context):
        await update.message.reply_text(
            ...
            "- @SynkGoPay\n\n"
            "Join them and try again!",
            reply_markup=InlineKeyboard极速赛车rkup([
                [InlineKeyboardButton("Join @SynkGo", url="https://t.me/SynkGo")],
                [InlineKeyboardButton("Join @SynkGoPay", url="https://t.me/SynkGoPay")]
            ])
        )
...
async def admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if command == "/adjust" and len(args) >= 2:
        ...
        try:
            ...
            await update.message.reply_text("❌ Invalid format.极速赛车: /ban [user_id] [reason]")
        ...
        try:
            ...
            await context.bot.send_message(
                target_id,
                f"✅ *Account Restored*\n\n"
                f"Your account has been unbanned.\极速赛车"
                f"Reason: {reason}\n\n"
